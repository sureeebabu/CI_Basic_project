...
<a class="btn btn-white btn-info btn-bold pull-right" href="<?php echo base_url('user/addEditUsers'); ?>"><i class="ace-icon fa fa-plus bigger-120 blue"></i> Add New User</a>
			...
			if(count($data)>0)
			{
				...
				foreach($data as $row)
				{
					...
					echo "<td class='text-center'>
						  	<a title='Edit User' href='".site_url('user/edit/'.$row->userID)."'>
							<i class='fa fa-edit' ></i>
							</a> &nbsp; | &nbsp;

							<a title='Delete User' onClick='return doconfirm();' href='".site_url('user/deleteFn/'.$row->userID)."'>
